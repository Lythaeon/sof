...
- [Use SOF](use-sof/README.md)
  ...
  - [Build An Observer Service](use-sof/observer-service.md)
  - [Build One Process That Observes And Submits](use-sof/observe-and-submit-service.md)
  - [Build A Live-Only Stream Service](use-sof/live-only-stream-service.md)
...
- [SDKs](sdk/README.md)
  ...
  - [Runtime Host and Packaging](sdk/runtime-host.md)
